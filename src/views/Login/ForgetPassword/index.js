...
const useStyles = makeStyles((theme) => ({
  root: {
    ...
    '& .MuiPaper-elevation1': {
      boxShadow: '0 0 0 1px #ffffff, 0 1px 3px 0 #fff'
    }
  },
  card: {
    ...
    >
        <Card className={classes.card}>
            ...
            <Grid item >
              ...
              underline="hover"
              >
                <ArrowBackIcon style={{fontSize:'3.5em'}}></ArrowBackIcon>
              </Link>
            </Grid> 
          </Grid>
            <Grid container
          ...
          >
            ...
            <Typography variant="subtitle2" style={{marginBottom:"30px", color:'#c0bbbb'}}>
              {t('Please enter the Email address associated with your laclasse account to recieve the password rest link')}
            </Typography>

          <ForgetForm className={classes.ForgetForm} />

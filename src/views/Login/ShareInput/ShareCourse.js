...
function ShareCourse({
  ...
  console.log("The Share Course is::", urlCode)
  return (
            ...
            <Collapse in={expandShareCourse}>
              <div className={classes.contentSectionContent}>
                ...
                <Grid xs={12} style={{ padding: '15px' }}>
                  <Grid container spacing={3} justify="space-around" alignItems="center">
                    <Grid item xs={3} style={{ textAlign: 'center' }}>
                      <WhatsappShareButton url={CONFIG.SITEURL + `/live/${urlCode}`}>
                    ...
                    <Grid item xs={3} style={{ textAlign: 'center' }}>
                      <FacebookShareButton style={{ borderWidth: '0px', backgroundColor: 'white' }}
                        url={CONFIG.SITEURL + `/live/${urlCode}`}
                    ...
                    <Grid item xs={3} style={{ textAlign: 'center' }}
                    >
                      <LinkedinShareButton url={CONFIG.SITEURL+`/live/${urlCode}`}>
                ...
                <Grid xs={12} style={{ padding: '15px' }}>
                  <Grid container spacing={3} justify="space-around" alignItems="center">
                    <Grid item xs={3} style={{ textAlign: 'center' }}>
                      <TwitterShareButton url={CONFIG.SITEURL + `/live/${urlCode}`}>
                    ...
                    <Grid item xs={3} style={{ textAlign: 'center' }}>
                      <TelegramShareButton url={CONFIG.SITEURL + `/live/${urlCode}`}>
                    ...
                    <Grid item xs={3} style={{ textAlign: 'center' }}>
                      <EmailShareButton url={CONFIG.SITEURL + `/live/${urlCode}`}>

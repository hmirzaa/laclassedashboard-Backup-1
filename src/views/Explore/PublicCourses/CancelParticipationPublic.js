...
function CancelParticipationPublic({
  ...
  const onCoursDelete = async () => {
    ...
    API.cancelParticpateRoom(thecours.id, token)
  ...
  console.log("The Cancel Participation is: ", thecours)
  if (!open) {
    return null;
  }
  ...
  return (
    ...
    >
      ...
      >
        ...
        <CardHeader title={t('cancel participation')} />
        <Divider />
        <CardContent>
...
CancelParticipationPublic.propTypes = {
  className: PropTypes.string,
  onClose: PropTypes.func,
  open: PropTypes.bool
};

CancelParticipationPublic.defaultProps = {
  open: false,
  onClose: () => { }
};

export default CancelParticipationPublic;
